...
class EspecialidadMotivoTurno extends Maestro {
	...
	public function vistaDetallada($especialidad_id){
		return DB::table('especialidad_motivo_turno')
			...
			->select(DB::raw("especialidad_motivo_turno.id,especialidad_motivo_turno.especialidad_id,especialidades.especialidad,especialidad_motivo_turno.motivo_turno_id,motivos_turnos.motivo"))
